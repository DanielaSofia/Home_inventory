...
4. Validate each finding against the local code and repository context, then make only the smallest authorized fix for actionable issues, prioritizing critical and major findings
